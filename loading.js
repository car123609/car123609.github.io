(function () {
    ...
    var config = window.TROPICAL_SANDBOX_CONFIG || {};
    var state = {
        totalFiles: 0,
        filesNeeded: 0,
        currentFile: "",
    ...
    window.GameDetails = function (serverName, serverUrl, mapName, maxPlayers, steamId, gamemode, volume, language) {
        elements.serverName.textContent = cleanText(serverName, config.fallbackServerName || "Tropical Sandbox");
    ...
    function runPreviewMode() {
        ...
        var remaining = 120;
        var previewFiles = [
            "materials/tropical_sandbox/water.vmt",
            "models/props_c17/furniturechair001a.mdl",
            "sound/tropical_sandbox/ambience/waves.ogg",
            "lua/autorun/client/tropical_hud.lua"
        ];
    ...
    elements.serverName.textContent = config.fallbackServerName || "Tropical Sandbox";
